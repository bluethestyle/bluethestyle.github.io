...
next_desc: "13 태스크 규모에서 Null 효과로 미채택된 adaTT, VRAM 한계로 기각된 GradSurgery, 여전히 WIP 상태인 Paper 3, 그리고 2026년 4월 30일 이후 수집이 시작된 실 프로덕션 메트릭의 현재 상태. 4개월 작업에서 '무엇이 작동하지 않았는가'에 대한 기록."
