...
lang: ko
excerpt: "4개월의 기록. 13개 태스크 환경에서 무의미한(Null) 수치로 수렴해버린 adaTT, 심각한 VRAM 오버헤드로 기각된 GradSurgery, 여전히 WIP인 Paper 3, 그리고 2026년 4월 30일부터 수집이 시작된 실 프로덕션 메트릭의 현재 상태. 작동하지 않은 것들이 작동한 것들만큼이나 중요한 이유를 기록한다."
series: three-months
part: 8
