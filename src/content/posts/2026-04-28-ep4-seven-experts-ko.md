...
2 의 Counterfactual C-C (반사실 Champion-Challenger) 를 가능하게
하는 유일한 전문가.
...
결정* — 이 3인 팀이 7개 전문가 아키텍처를 약 6주에 검증할 수 있었던
방법이다. 각 프로토타입은 대개 300줄 미만의 일회용 코드였지만,
...
이건 "이종 expert 가 논문상 아이디어였다" 에서 *실제로 작동했다*
로의 전환이다.
