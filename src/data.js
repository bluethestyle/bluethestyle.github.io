...
export const POSTS = [
  ...
  // PLE-4
  { date: "2026-04-19", title: "[Study Thread] PLE-4 — CGC 게이팅의 두 변형과 HMM Triple-Mode 라우팅", cat: "Study Thread", lang: "KO", url: "/2026/04/19/ple-4-cgc-hmm-routing-ko/", ex: "가중합 방식의 CGCLayer 와 블록 스케일링 방식의 CGCAttention — 두 CGC 변형의 수식. Expert Collapse 를 막는 entropy 정규화, 이종 차원 비대칭을 보정하는 차원 정규화, 그리고 HMM Triple-Mode 라우팅의 전체 구조.", tags: ["study-thread","ple","cgc","hmm","regularization"] },
  { date: "2026-04-19", title: "[Study Thread] PLE-4 — Two CGC Gate Variants and HMM Triple-Mode Routing", cat: "Study Thread", lang: "EN", url: "/2026/04/19/ple-4-cgc-hmm-routing-en/", ex: "The weighted-sum CGCLayer vs the block-scaling CGCAttention — math for both variants. Entropy regularization to prevent Expert Collapse, dimension normalization to correct heterogeneous output asymmetry, and the full HMM Triple-Mode routing architecture.", tags: ["study-thread","ple","cgc","hmm","regularization"] },
  // PLE-3
  { date: "2026-04-19", title: "[Study Thread] PLE-3 — 입력 구조와 이종 Shared Expert Pool (576D)", cat: "Study Thread", lang: "KO", url: "/2026/04/19/ple-3-heterogeneous-expert-pool-ko/", ex: "PLEClusterInput 의 전체 필드 사양과 734D features 텐서 인덱스 매핑, HMM 모드 라우팅. 그리고 본 프로젝트의 8개 이종 Shared Expert 가 각자 어떤 수학적 관점으로 고객을 해석하는지.", tags: ["study-thread","ple","expert-pool","hmm","shared-experts"] },
  { date: "2026-04-19", title: "[Study Thread] PLE-3 — Input Structure and Heterogeneous Shared Expert Pool (576D)", cat: "Study Thread", lang: "EN", url: "/2026/04/19/ple-3-heterogeneous-expert-pool-en/", ex: "The full PLEClusterInput field spec, 734D feature-tensor index mapping, and HMM mode routing. Plus the eight heterogeneous Shared Experts this project runs, each interpreting the customer through a structurally different mathematical lens.", tags: ["study-thread","ple","expert-pool","hmm","shared-experts"] },
  // PLE-2
